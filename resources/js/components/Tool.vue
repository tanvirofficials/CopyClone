...
<div align='right'>
	...
	<button @click="fire" style="margin: auto auto; background: #4099DE; padding: 5px 12px; color: #fff; font-weight:bold;   border-radius: 10px;">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" class="fill-current">
			<path
